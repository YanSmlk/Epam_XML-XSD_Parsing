...
public class Newspaper implements BasePaper
{
    private String id;
    private int index;
    ...
    public Newspaper(String id, int index, String title, boolean mounthly, boolean colored, int pages, boolean glossy)
    {
        this.id=id;
        this.index=index;
        this.title=title;
    ...
    public Newspaper(String id, int index)
    {
        this.id=id;
        this.index=index;
    }
